...
!function (a, b) {
  ...
  o.fn = o.prototype = {
    ...
    for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == _typeof(g) || o.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++) {
      if (null != (a = arguments[h])) for (b in a) {
        c = g[b], g !== (d = a[b]) && (j && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? (e = !1, f = c && o.isArray(c) ? c : []) : f = c && o.isPlainObject(c) ? c : {}, g[b] = o.extend(j, f, d)) : void 0 !== d && (g[b] = d));
      }
    }
    ...
    function tb(a, b, c, d, e, f) {
      return d && !d[s] && (d = tb(d)), e && !e[s] && (e = tb(e, f)), fb(function (f, g, h, i) {
        var j,
            ...
            r = c ? e || (f ? a : o || d) ? [] : g : q;
        if (c && c(q, r, h, i), d) for (j = sb(r, n), d(j, [], h, i), k = j.length; k--;) {
          (l = j[k]) && (r[n[k]] = !(q[n[k]] = l));
        }
  ...
  var J = o.access = function (a, b, c, d, e, f, g) {
    var h = 0,
        i = a.length,
        j = null == c;
    if ("object" === o.type(c)) for (h in e = !0, c) {
  ...
  o.acceptData = function (a) {
    ...
    remove: function remove(a, b) {
      ...
      if (void 0 === b) this.cache[f] = {};else {
        o.isArray(b) ? d = b.concat(b.map(o.camelCase)) : (e = o.camelCase(b), d = b in g ? [b, e] : (d = e) in g ? [d] : d.match(E) || []), c = d.length;
    ...
    data: function data(a, b) {
      ...
      if (void 0 === a) {
        if (this.length && (e = M.get(f), 1 === f.nodeType && !L.get(f, "hasDataAttrs"))) {
          for (c = g.length; c--;) {
            0 === (d = g[c].name).indexOf("data-") && (d = o.camelCase(d.slice(5)), P(f, d, e[d]));
          }
  ...
  o.event = {
    ...
    add: function add(a, b, c, d, e) {
      var f,
          ...
          q,
          r = L.get(a);
      if (r) for (c.handler && (c = (f = c).handler, e = f.selector), c.guid || (c.guid = o.guid++), (i = r.events) || (i = r.events = {}), (g = r.handle) || (g = r.handle = function (b) {
        return _typeof(o) !== U && o.event.triggered !== b.type ? o.event.dispatch.apply(a, arguments) : void 0;
      }), j = (b = (b || "").match(E) || [""]).length; j--;) {
        n = q = (h = Y.exec(b[j]) || [])[1], p = (h[2] || "").split(".").sort(), n && (l = o.event.special[n] || {}, n = (e ? l.delegateType : l.bindType) || n, l = o.event.special[n] || {}, k = o.extend({
          type: n,
          origType: q,
          data: d,
          handler: c,
    ...
    trigger: function trigger(b, c, d, e) {
      ...
      if (g = h = d = d || m, 3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + o.event.triggered) && (q.indexOf(".") >= 0 && (r = q.split("."), q = r.shift(), r.sort()), k = q.indexOf(":") < 0 && "on" + q, (b = b[o.expando] ? b : new o.Event(q, "object" == _typeof(b) && b)).isTrigger = e ? 2 : 3, b.namespace = r.join("."), b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [b] : o.makeArray(c, [b]), n = o.event.special[q] || {}, e || !n.trigger || !1 !== n.trigger.apply(d, c))) {
        ...
        for (f = 0; (g = p[f++]) && !b.isPropagationStopped();) {
          b.type = f > 1 ? i : n.bindType || q, (l = (L.get(g, "events") || {})[b.type] && L.get(g, "handle")) && l.apply(g, c), (l = k && g[k]) && l.apply && o.acceptData(g) && (b.result = l.apply(g, c), !1 === b.result && b.preventDefault());
        }
      ...
      if (i[0] = a, a.delegateTarget = this, !k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
        for (h = o.event.handlers.call(this, a, j), b = 0; (f = h[b++]) && !a.isPropagationStopped();) {
          for (a.currentTarget = f.elem, c = 0; (g = f.handlers[c++]) && !a.isImmediatePropagationStopped();) {
            (!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, void 0 !== (e = ((o.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)) && !1 === (a.result = e) && (a.preventDefault(), a.stopPropagation()));
          }
        }
    ...
    handlers: function handlers(a, b) {
      ...
      if (h && i.nodeType && (!a.button || "click" !== a.type)) for (; i !== this; i = i.parentNode || this) {
        if (!0 !== i.disabled || "click" !== a.type) {
          for (d = [], c = 0; h > c; c++) {
            void 0 === d[e = (f = b[c]).selector + " "] && (d[e] = f.needsContext ? o(e, this).index(i) >= 0 : o.find(e, this, null, [i]).length), d[e] && d.push(f);
          }
    ...
    fix: function fix(a) {
      ...
      for (g || (this.fixHooks[e] = g = W.test(e) ? this.mouseHooks : V.test(e) ? this.keyHooks : {}), d = g.props ? this.props.concat(g.props) : this.props, a = new o.Event(f), b = d.length; b--;) {
        a[c = d[b]] = f[c];
      }
  ...
  function nb(a, b) {
    ...
    if (1 === b.nodeType) {
      if (L.hasData(a) && (f = L.access(a), g = L.set(b, f), j = f.events)) for (e in delete g.handle, g.events = {}, j) {
  ...
  ib.optgroup = ib.option, ib.tbody = ib.tfoot = ib.colgroup = ib.caption = ib.thead, ib.th = ib.td, o.extend({
    clone: function clone(a, b, c) {
      ...
      if (!(l.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || o.isXMLDoc(a))) for (g = ob(h), d = 0, e = (f = ob(a)).length; e > d; d++) {
        pb(f[d], g[d]);
      }
    ...
    buildFragment: function buildFragment(a, b, c, d) {
      for (var e, f, g, h, i, j, k = b.createDocumentFragment(), l = [], m = 0, n = a.length; n > m; m++) {
        if ((e = a[m]) || 0 === e) if ("object" === o.type(e)) o.merge(l, e.nodeType ? [e] : e);else if (cb.test(e)) {
      ...
      for (k.textContent = "", m = 0; e = l[m++];) {
        if ((!d || -1 === o.inArray(e, d)) && (i = o.contains(e.ownerDocument, e), f = ob(k.appendChild(e), "script"), i && mb(f), c)) for (j = 0; e = f[j++];) {
    ...
    cleanData: function cleanData(a) {
      for (var b, c, d, e, f, g, h = o.event.special, i = 0; void 0 !== (c = a[i]); i++) {
        if (o.acceptData(c) && (f = c[L.expando]) && (b = L.cache[f])) {
          if ((d = Object.keys(b.events || {})).length) for (g = 0; void 0 !== (e = d[g]); g++) {
    ...
    html: function html(a) {
      return J(this, function (a) {
        ...
        if ("string" == typeof a && !db.test(a) && !ib[(bb.exec(a) || ["", ""])[1].toLowerCase()]) {
          ...
          try {
            for (; d > c; c++) {
              1 === (b = this[c] || {}).nodeType && (o.cleanData(ob(b, !1)), b.innerHTML = a);
            }
  ...
  function Jb(a, b) {
    for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++) {
      (d = a[g]).style && (f[g] = L.get(d, "olddisplay"), c = d.style.display, b ? (f[g] || "none" !== c || (d.style.display = ""), "" === d.style.display && S(d) && (f[g] = L.access(d, "olddisplay", tb(d.nodeName)))) : f[g] || (e = S(d), (c && "none" !== c || !e) && L.set(d, "olddisplay", e ? c : o.css(d, "display"))));
    }
  ...
  function Vb(a, b, c) {
    ...
    if (!o.isEmptyObject(l)) for (d in p ? "hidden" in p && (n = p.hidden) : p = L.access(a, "fxshow", {}), f && (p.hidden = !n), n ? o(a).show() : k.done(function () {
      o(a).hide();
    }), k.done(function () {
      var b;

      for (b in L.remove(a, "fxshow"), l) {
        o.style(a, b, l[b]);
      }
    }), l) {
  ...
  function Wb(a, b) {
    ...
    for (c in a) {
      if (e = b[d = o.camelCase(c)], f = a[c], o.isArray(f) && (e = f[1], f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), (g = o.cssHooks[d]) && "expand" in g) for (c in f = g.expand(f), delete a[d], f) {
  ...
  function Xb(a, b, c) {
    var d,
      ...
      for (var b = Lb || Sb(), c = Math.max(0, j.startTime + j.duration - b), d, f = 1 - (c / j.duration || 0), g = 0, i = j.tweens.length; i > g; g++) {
        j.tweens[g].run(f);
      }
  ...
  o.fn.extend({
    ...
    attr: function attr(a, b, c) {
      var d,
          e,
          f = a.nodeType;
      if (a && 3 !== f && 8 !== f && 2 !== f) return _typeof(a.getAttribute) === U ? o.prop(a, b, c) : (1 === f && o.isXMLDoc(a) || (b = b.toLowerCase(), d = o.attrHooks[b] || (o.expr.match.bool.test(b) ? Zb : Yb)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : null == (e = o.find.attr(a, b)) ? void 0 : e : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void o.removeAttr(a, b));
    },
  ...
  o.fn.extend({
    ...
    toggleClass: function toggleClass(a, b) {
      ...
      return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : this.each(o.isFunction(a) ? function (c) {
        ...
        if ("string" === c) for (var b, d = 0, e = o(this), f = a.match(E) || []; b = f[d++];) {
  ...
  ec = mc.exec(fc.toLowerCase()) || [], o.extend({
    ...
    ajax: function ajax(a, b) {
      ...
      for (j in (i = k.global) && 0 == o.active++ && o.event.trigger("ajaxStart"), k.type = k.type.toUpperCase(), k.hasContent = !kc.test(k.type), d = k.url, k.hasContent || (k.data && (d = k.url += (dc.test(d) ? "&" : "?") + k.data, delete k.data), !1 === k.cache && (k.url = hc.test(d) ? d.replace(hc, "$1_=" + cc++) : d + (dc.test(d) ? "&" : "?") + "_=" + cc++)), k.ifModified && (o.lastModified[d] && v.setRequestHeader("If-Modified-Since", o.lastModified[d]), o.etag[d] && v.setRequestHeader("If-None-Match", o.etag[d])), (k.data && k.hasContent && !1 !== k.contentType || b.contentType) && v.setRequestHeader("Content-Type", k.contentType), v.setRequestHeader("Accept", k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + pc + "; q=0.01" : "") : k.accepts["*"]), k.headers) {
  ...
  a.ActiveXObject && o(a).on("unload", function () {
    ...
    return l.cors || Fc && !a.crossDomain ? {
      send: function send(c, d) {
        ...
        for (e in a.mimeType && f.overrideMimeType && f.overrideMimeType(a.mimeType), a.crossDomain || c["X-Requested-With"] || (c["X-Requested-With"] = "XMLHttpRequest"), c) {
    ...
    offset: function offset(a) {
      ...
      var b,
        ...
        left: 0
          ...
          f = d && d.ownerDocument;
      return f ? (b = f.documentElement, o.contains(b, d) ? (_typeof(d.getBoundingClientRect) !== U && (e = d.getBoundingClientRect()), c = Kc(f), {
